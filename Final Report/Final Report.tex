...
The we calculate the overall accuracy: $\text{# of cases with all 24 correct predictions} / \text{total # of cases}$. In this case, the overall accuracy rate is 98\% which shows SVM method accurate result.
