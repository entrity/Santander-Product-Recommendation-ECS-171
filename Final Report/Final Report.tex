...
\textbf{XGBoost} \\
Xinyi Hou: Lead the project as a whole, pre-processed data, and wrote final abstract. \\
Yingxi Yu:  Wrote the model code and made the powerpoint. \\
Wenyu Li: Wrote model code and the group's report. \\
Yuan Xu: Worked on the group's report. \\
\textbf{Random Forest} \\
