...
\noindent \indent XGBoost is short for ``Extreme Gradient Boosting" and is widely used in machine learning problems, especially classification problems\cite{xg1}\cite{xg2}. To find the best parameters given the training data, we need to define a objective function,which contains two parts: training loss and regularization.
\[
