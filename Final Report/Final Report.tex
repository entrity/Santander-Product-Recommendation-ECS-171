...
\subsection{Author Contributions}
\begin{itemize}
	\item Bowen He: data analysis & interpretation; coded purchase-history vars; feature engineering; combined & revised report 'Discussion'

	\item Yuan Tian: data analysis & interpretation; coded data cleaning; planned ETL, revised report

	\item Miao Wang: data analysis & interpretation; coded response vars; feature engineering; revised report

	\item Markham Anderson: wrote subgroup report; data processing; coded regression model, performed classification
\end{itemize}
