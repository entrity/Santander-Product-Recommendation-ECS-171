...
\begin{enumerate}
	...
	For the cases having missing values in any of the 24 dependent variables, we remove them. This case occurs < 1\% of the time and has no obvious pattern.

	\item Data Transformation

	We transform categorical variables to dummy variables, and standardize the continuous variables.
\end{enumerate}
